<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_Page.aspx.cs" Inherits="MIS332_01.Home_Page" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table ID="Table1" runat="server" Style="width: 100%; text-align: center;">
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center" Style="width: 20%;">
                    <asp:Label ID="Label13" runat="server" Text="Login/Register" Style="font-size: 22px; color: teal"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table ID="Table2" runat="server" CssClass="content-section">
            <asp:TableRow>
                ...
                <asp:TableCell CssClass="image-content">
                    <asp:Image ID="Image2" runat="server" ImageUrl="img/astro1.jpeg" Style="width: 400px" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table ID="Table3" runat="server" CssClass="content-section">
            <asp:TableRow>
                ...
                <asp:TableCell CssClass="image-content">
                    <asp:Image ID="Image3" runat="server" ImageUrl="img/innovagri.jpeg" Style="width: 400px" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
